...
syn keyword snaskKeyword let mut const fun class self return new import import_c_om from as extern
...
syn keyword snaskBuiltin is_nil is_str is_obj is_int is_float is_bool is_list is_dict
syn keyword snaskBuiltin read_file write_file append_file exists delete read_dir is_file is_dir create_dir
...
syn keyword snaskBuiltin parse_int parse_float to_string to_bool type_of
syn keyword snaskLowLevel int float f32 f64 i8 i16 i32 i64 u8 u16 u32 u64 ptr bool str num any void isize usize
...
syn match snaskNumber "\v<\d+%(\.\d+)?([eE][+-]?\d+)?>"
...
hi def link snaskTypeAnnotation Type
