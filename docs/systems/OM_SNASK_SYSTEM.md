# OM-Snask-System v0.4.1-alpha

## O sistema unico de memoria, recursos e interop nativa do Snask

Nota de documentacao: blocos de codigo neste documento sao principalmente desenho de API e fluxo de interop. Por isso, exemplos foram marcados como `text` quando dependem de scanner, biblioteca externa, patch OM ou recurso ainda experimental.
