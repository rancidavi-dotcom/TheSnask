# Plano Low-Level do Snask v0.4.1-alpha
...
## Nota de documentacao

Este arquivo e plano de arquitetura. Blocos `text` representam sintaxe futura ou conceitual; exemplos compilaveis ficam na referencia e no guia de aprendizado.
