...
Este roadmap e direcao de produto/engenharia. O status real de cada item deve ser conferido em `docs/reference/FEATURE_STATUS.md`; exemplos prontos para copiar ficam em `docs/reference/LEARN_SNASK.md` e `docs/reference/LANGUAGE_REFERENCE.md`.
