...
```snif
{
  ...
  dependencies: { json: "*", },
  build: { opt_level: 2, profile: "release", },
}
```
...
- `build.profile` (optional: `dev` | `release` | `release-size` | `tiny`)
- `build.strip` (optional bool)
- `build.lto` (optional: `off` | `thin`)
- `build.opt` (optional: `O2` | `O3` | `Os` | `Oz`)
